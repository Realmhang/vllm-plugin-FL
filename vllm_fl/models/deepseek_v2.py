...
from vllm_fl.mx_utils.deep_gemm import bf16_mqa_logits, bf16_paged_mqa_logits
from vllm.utils.torch_utils import direct_register_custom_op
from vllm_fl.v1.attention.backends.mla.indexer import (
...
if current_platform.is_cuda_alike():
    ...
    from vllm_fl import _custom_ops as mx_ops
...
class Indexer(nn.Module):
    ...
    def forward(
        ...
        k_nope = k_nope.unsqueeze(1).expand(-1, self.n_head, -1)  # [2048, 32, 64]

        k_pe = k_pe.expand(-1, self.n_head, -1)  # [2048, 32, 64]

        q = torch.cat([q_pe, q_nope], dim=-1)  # [2048, 32, 128]
        k = torch.cat([k_pe, k_nope], dim=-1)  # [2048, 32, 128]

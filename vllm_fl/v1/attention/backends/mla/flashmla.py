...
from vllm_fl.attention.ops.flashmla import (
...
from vllm_fl.v1.attention.backends.mla.common import (
    MLACommonBackend,
...
class MacaFlashMLABackend(MLACommonBackend):
    ...
    def supports_combination(
        ...
        if use_sparse:
            from vllm_fl.attention.ops.flashmla import is_flashmla_sparse_supported

            return is_flashmla_sparse_supported()[1]
        else:
            from vllm_fl.attention.ops.flashmla import is_flashmla_dense_supported
